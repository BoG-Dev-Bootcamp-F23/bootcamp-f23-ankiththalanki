    ...
    return (<div className="train">
        <div className="leftstuff">
            ...
            <div className="trainInformation">
                ...
                {toNormalCase(props.STATION)} <img src="https://static.thenounproject.com/png/2094742-200.png" width="20"/> {toNormalCase(props.DESTINATION)}
                </div>
        ...
        <div className="time" style={textStyle}>
            ...
            {(props.WAITING_TIME === "Arriving" ? "": "min")}
        </div>
    </div>);
